...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <Container className="relative z-20 flex flex-col items-center pb-16 pt-0 text-center sm:pb-20 sm:pt-0">
        <Reveal>
          <Image
            src="/stait-logo.svg"
            alt="stait logo"
        ...
        <Reveal delayMs={280}>
          <div className="mt-10 w-full max-w-xl rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-left text-sm leading-relaxed text-neutral-700">
